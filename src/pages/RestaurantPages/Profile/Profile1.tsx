...
import NavBar1 from '@/components/profile/sidebarComponent1';
import { SetUp1 } from '@/components/profile/setupComponent1';
interface Address {
  title: string;
  address: {
    label: string;
    ...
    <>
      <div className="bg-white " style={{
        ...
        <div style={{
            ...
            <NavBar1 activeStep={1} />
        </div>
        <div style={{
            width:'70%'
        }}>
            <div className="w-3/4 sec_page" style={{
            marginLeft:30,
            display:'flex',
